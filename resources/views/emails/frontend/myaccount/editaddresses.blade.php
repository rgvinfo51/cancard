...
<form action="{{route('update.more.addresses')}}" method="POST" onsubmit="return ValidateForm()">
    ...
    <div class="form-row row">
        <div class="col-12 form-group required mb-1">
            <label class="control-label" for="address1">Shipping Address 1</label> <input autocomplete="off" class="form-control card-num" placeholder="Enter Shipping Address 1" name="address1" id="address1" size="20" type="text" required value="{{$address['address1']}}">
        </div>
    </div>

    <div class="form-row row">
        <div class="col-12 form-group mb-1">
            <label class="control-label font-12" for="address2">Shipping Address 2</label> <input autocomplete="off" class="form-control card-cvc" placeholder="Enter Shipping Address 2" size="4" type="text" name="address2" id="address2" value="{{$address['address2']}}">
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-4 form-group mb-3">
            <label class="control-label font-12" for="province">Province</label>
        ...
        <div class="row">
            <div class="col-4 form-group mb-1">
                <label class="control-label font-12" for="zipcode">Zipcode/Postal Code</label> <input autocomplete="off" class="form-control card-cvc" placeholder="Enter Zipcode/Postal Code" size="4" type="text" name="zipcode" id="zipcode" required value="{{$address['zipcode']}}">

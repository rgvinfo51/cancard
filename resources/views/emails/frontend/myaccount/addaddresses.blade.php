    ...
    <div class="card-body bg-white">
            ...
            <div class="form-row row">
                <div class="col-12 form-group required mb-3">
                    <label class="control-label" for="address1">Address 1</label> <input autocomplete="off" class="form-control card-num" placeholder="Enter Address 1" name="address1" id="address1" size="20" type="text" required>
                </div>
            </div>

            <div class="form-row row">
                <div class="col-12 form-group mb-3">
                    <label class="control-label font-12" for="address2">Address 2</label> <input autocomplete="off" class="form-control card-cvc" placeholder="Enter Address 2" size="4" type="text" name="address2" id="address2">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 mb-3 m-0 p-0">
                    <div class="col-md-4 mb-2">
                        <label class="control-label font-12" for="zipcode">Zipcode/Postal Code</label> <input autocomplete="off" class="form-control card-cvc" placeholder="Enter Zipcode/Postal Code" size="4" type="text" name="zipcode" id="zipcode" required>
                    </div>

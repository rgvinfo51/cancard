                ...
                <div class="orders-program">
                    <table class="orders-program-con table table-bordered">
                        <thead style="border-bottom: black 1px solid;">
                            <tr>
                                <th style="font-weight: bold;" width="130">Date</th>
                                <th style="font-weight: bold;" width="110">Order ID</th>
                                <th style="font-weight: bold;" width="100">PO</th>
                                <th style="font-weight: bold;" width="250">Ship To</th>
                                <th style="font-weight: bold;" width="250">Bill To</th>
                        ...
                        <tbody>
                            ...
                            <tr style="font-size: 14px;">
                                ...
                                <td>{{ $order->sstreetaddress1 }} {{ $order->sstreetaddress2 }} {{ $order->scity }}, {{ $order->spostcode }}</td>

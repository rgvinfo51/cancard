                                    ...
                                    <div class="shipping-right-down">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6 text-right">
                                                <!-- <a onclick="shippingAddress('edit','{{ $address['id'] }}')" style="color : #024d8d !important;padding-right:5px;" href="{{route('edit.more.addresses',$address['id'])}}">Edit</a>| -->
                                                <a onclick="shippingAddress('edit','{{ $address['id'] }}')" style="color : #024d8d !important;padding-right:5px;cursor: pointer;">Edit</a>|
                                                <a style="color : #024d8d !important;padding-right:5px;" href="{{route('delete.more.addresses',$address['id'])}}">Remove</a>

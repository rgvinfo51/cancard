                    ...
                    <div class="orders-details row">
                        ...
                        <div class="order-content col-md-2 col-sm-12">
                            @if($order->invoice_type == 1)
                             <a href="{{ asset('storage/uploads/invoice_file/'.$order->invoice_uploaded_file) }}" target="_BLANK" style="display: table-cell;vertical-align: middle;" class="btn btn-outline-info">View/Print Invoice</a>

        ...
        <div class="myaccount-content-block">
            ...
            <div class="right-con address-profile-con">
                ...
                @csrf
                    ...
                    <div class="first-last-name-con">
                        <div class="address-one-con">
                            <span class="input-name">Address Line 1*</span>
                        ...
                        <div class="address-one-con">
                            <span class="input-name">Address Line 2(Optional)</span>
                    ...
                    <div class="first-last-name-con">
                        <div class="address-one-con">
                            <span class="input-name">Province/State*</span>
                        ...
                        <div class="address-one-con">
                            <span class="input-name">Postal Code/Zipcode*</span>

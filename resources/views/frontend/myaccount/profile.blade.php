        ...
        <div class="myaccount-content-block">    
            ...
            <div class="right-con address-profile-con">
                ...
                @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <label class="profile_label">Full Name * </label>
                            <input type="text" class="input_field" name="name" id="name" value="{{ $customerdata['name'] }}" required disabled>
                            @if ($errors->has('name'))
                                <span class="text-danger">{{ $errors->first('name') }}</span>
                            @endif
                        </div>
                        <div class="col-md-6">
                            <label class="profile_label">Title/Role * </label>
                            <input type="text" class="input_field" name="posttitle" id="posttitle" required disabled value="{{ $customerdata['posttitle'] }}">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <label class="profile_label">Company Name * </label>
                            <input type="text" class="input_field" name="company" id="company" required disabled value="{{ $customerdata['company'] }}" required>
                            @if ($errors->has('company'))
                                <span class="text-danger">{{ $errors->first('company') }}</span>
                            @endif
                        </div>
                        <!-- <div class="col-md-6">
                            <label class="profile_label">Industry * </label>
                            <select>
                                <option></option>
                            </select>
                        </div> -->
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="email" class="input_field"  name="email" id="email" disabled required value="{{ $customerdata['email'] }}" readonly="">
                            @if ($errors->has('email'))
                                <span class="text-danger">{{ $errors->first('email') }}</span>
                            @endif
                        </div>
                        <div class="col-md-6">
                            <label class="profile_label">Alternate Email <span style="font-size: 16px !important;font-weight: normal !important;">(Optional)</span></label>
                            <input type="email" class="input_field"  name="alt_email" id="alt_email" disabled value="{{ $customerdata['alt_email'] }}" >
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <label class="profile_label">Office Phone * </label>
                            <input type="number" class="input_field" name="officeno" id="officeno" disabled value="{{ $customerdata['office_no'] }}">
                            @if ($errors->has('officeno'))
                                <span class="text-danger">{{ $errors->first('officeno') }}</span>
                            @endif
                        </div>
                        <div class="col-md-6">
                            <label class="profile_label">Phone No * </label>
                            <input type="text" class="input_field" name="phoneno" id="phoneno" disabled value="{{ $customerdata['phoneno'] }}" required>
                    ...
                    <!-- <div class="address-one-con p-0 m-0">
                        <label class="profile_label">Customer ID</label>
                        <input type="text" class="input_field" name="customer_id" value="{{ $customerdata['customer_id'] }}" readonly>
                    ...
                    <div class="address-one-con p-0 m-0">
                        <label class="profile_label">Address Line 1 * </label>
                        <input type="text" class="input_field" name="corporateaddress" disabled id="corporateaddress" value="{{ $customerdata['corporateaddress'] }}">
                    ...
                    <div class="address-one-con p-0 m-0">
                        <label class="profile_label">Address Line 2 <span style="font-size: 16px !important;font-weight: normal !important;">(Optional)</span></label>
                        <input type="text" class="input_field" name="address2" disabled id="address2" value="{{ $customerdata['address2'] }}">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="input_field" name="city" disabled id="city" value="{{ $customerdata['city'] }}">
                            @if ($errors->has('city'))
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="country" class="input_field" id="country" disabled onchange="fetchProvince(this.value)" required style="font-size: 16px;padding: 0px;padding-left: 15px;">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <label class="profile_label">Province/State *</label>
                            <select name="province" class="input_field" id="province" disabled required style="font-size: 16px;padding: 0px;padding-left: 15px;">
                        ...
                        <div class="col-md-6">
                            <label class="profile_label">Postal Code/Zipcode *</label>
                            <input autocomplete="off" class="card-cvc input_field" disabled size="4" type="text" name="zipcode" id="zipcode" value="{{ $customerdata['zipcode'] }}" style="font-size: 16px;padding: 0px;padding-left: 15px;">
                    ...
                    <div class="submit-savechanges p-0">
                        ...
                        <a class="btn-primary btn edit_profile my-5" onclick="editUserProfile('edit')">Edit Profile</a>
                        <button class="btn-primary btn update_profile my-5" style="display: none;">Update Profile</button>

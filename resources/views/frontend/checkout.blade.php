                ...
                <div class="row">
                    <div class="col-12 col-lg-8">
                        <div class="ps-checkout__form">
                            ...
                            @if($customerdata->bill_firstname == '' 
                            && $customerdata->bill_lastname == '' 
                            ...
                            <span class="text-danger">Please provide billing details in the customer dashboard!</span>
                            @endif

                            @if ($errors->has('shipingaddress'))
                                <span class="text-danger">{{ $errors->first('shipingaddress') }}</span>
                            @endif
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    ...
                                    <h3 class="ps-checkout__heading">Your Shipping Address</h3>
 

                                    @if($addresses->isEmpty())
                                    <span class="text-danger">Please provide shipping details in the customer dashboard!</span>
                                        <input class="ps-input" type="hidden" name="shipingaddress" value="" required>
                                    @else  
                                    <input class="ps-input" type="hidden" name="shipingaddress" value="1">
                                    @endif
                                    ...
                                    <div class="row">
                                            @foreach($addresses as $address)
                                                <label style="cursor: pointer; border-radius: 8px;" class="col-md-5 mx-4 p-3 shadow">
